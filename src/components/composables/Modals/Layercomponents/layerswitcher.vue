<template>
  <div class="column q-pa-none" style="max-width: 350px">
    <div class="row bg-primary q-px-md q-py-sm">{{ layer_name }}</div>
...
watch(selectedDate, ()=> {
  date.value = `${store.selectedDate.slice(0, 4)}/${store.selectedDate.slice(4, 6)}/${store.selectedDate.slice(6, 8)}`;
})
